#tag DesktopWindow
Begin DesktopWindow AllPlayersWindow
   Backdrop        =   0
   ...
   Begin DesktopListBox PlayerList
      ...
      Index           =   -2147483648
      InitialParent   =   ""
      InitialValue    =   "Team	Name	Age	Positions"
      Italic          =   False
      Left            =   20
      LockBottom      =   True
	...
	#tag Method, Flags = &h21
		Private Sub LoadPlayers()
		  ...
		  For Each o As Storm.DBObject In AllPlayers
		    ...
		    t = p.Team
		    PlayerList.AddRow(t.Name.StringValue, p.Name.StringValue, p.Age.StringValue, p.Positions.StringValue)
		  Next
		End Sub
	#tag EndMethod
